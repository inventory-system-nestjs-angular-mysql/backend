...
import { IPurchasingRepository } from '../../../../core/purchasing/repositories/purchasing.repository.interface';

const SPECIAL = 'BL';

@Injectable()
export class PurchasingRepository implements IPurchasingRepository {
  constructor(
