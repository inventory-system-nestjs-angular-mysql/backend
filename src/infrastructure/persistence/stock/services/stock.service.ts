...
export class StockService extends BaseService {
  ...
  async create(
    ...
    const stockPartial: Partial<Stock> = {
      ...
      brandId: createStockDto.brand ?? null,
      entityId: createStockDto.supplier ?? null,
  ...
  async update(
    ...
    const updateData: Partial<Stock> = {
      ...
      ...(updateStockDto.supplier !== undefined && { entityId: updateStockDto.supplier }),
